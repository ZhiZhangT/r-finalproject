...
ggplot(clean_resale_data_2020_onwards, aes(x = remaining_lease, y = resale_price)) +
  ...
  labs(title = "Resale Prices vs. Remaining Lease", x = "Remaining Lease (Years)", y = "Resale Price (SGD)")
```
Filtering the data to analyse only those within a shorter time period gave us a much clearer trend regarding the relationship between remaining lease and resale price.
In general, we see that the resale price decreases as the remaining lease decreases. 
